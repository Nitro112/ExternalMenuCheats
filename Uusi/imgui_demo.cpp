...
static void ShowExampleAppSimpleOverlay(bool* p_open)
{
    ...
    if (ImGui::Begin("Example: Simple overlay", p_open, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoFocusOnAppearing | ImGuiWindowFlags_NoNav))
    {
		ImGui::Checkbox("bhop", &bhop);
		ImGui::Checkbox("autofire", &autofire);
		ImGui::Checkbox("triggerbot", &asd);
		ImGui::Checkbox("wallhack", &asd1);
        if (ImGui::BeginPopupContextWindow())
        {
